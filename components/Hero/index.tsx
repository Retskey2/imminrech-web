...
const Hero = () => {
  return (
    <div className="flex justify-center items-center mt-24 gap-20 mb-40">
      <main className="max-w-[840px]">
        ...
        <button className="px-12 py-4 border-solid border-[0.5px] font-medium border-white rounded text-xl hover:bg-[#CEFF45] hover:border-[#CEFF45] hover:text-black">
          Обсудить проект
        </button>
      </main>
