...
export const services = [
	{
		...
		title: 'Разработка',
		description:
			'Разработка мобильного приложения, специально настроенного под ваши бизнес-потребности. Команда профессиональных разработчиков и дизайнеров возьмёт на себя всю работу, начиная с концептуализации и проектирования, до внедрения и тестирования.'
	},
	{
		id: 2,
		title: 'Разработка дизайна',
		description:
			'Включает в себя создание оригинального и привлекательного дизайна для различных целей'
	},
	{
		id: 3,
